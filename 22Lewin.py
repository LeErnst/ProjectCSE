...
values_list = [(0.99, 1e-6, r'\roh=0.99, $\epsilon$=1e-6,'),
               (0.99, 1e-7, r'\roh=0.99, $\epsilon$=1e-7,'),
               (0.99, 1e-8, r'\roh=0.99, $\epsilon$=1e-8,'),
               (0.99, 1e-9, r'\roh=0.99, $\epsilon$=1e-9'),
               (0.5, 1e-8, r'\roh=0.5, $\epsilon$=1e-8'),
               (0.1, 1e-8, r'\roh=0.1, $\epsilon$=1e-8')]


for (roh, epsilon, legend) in values_list:
    #####################################NeuAnfang##################################
    ...
    plotsettings = {'fig'      : 1,
                    'title'    : 'adadelta \n gtol = 500, maxiter = 30, sample parameter = bundle',
